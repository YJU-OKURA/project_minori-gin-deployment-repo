...
//		pc.Close()
//		log.Println("ICE gathering failed to complete in time.")
...
//		log.Println("Extending the timeout did not help.")
//		pc.Close()
//		return fmt.Errorf("peer connection setup timed out after extended period")
//	}
//
